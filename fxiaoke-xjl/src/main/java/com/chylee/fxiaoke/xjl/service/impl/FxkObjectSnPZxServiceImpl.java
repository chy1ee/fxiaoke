...
@Service
public class FxkObjectSnPZxServiceImpl extends AbstractCrmServiceImpl implements FxkObjectSnPZxService {
    private final FxkObjectService objectService;
    private final FxkPersonnelObjService personnelObjService;

    public FxkObjectSnPZxServiceImpl(AccessTokenManager accessTokenManager, FxkObjectService objectService,
