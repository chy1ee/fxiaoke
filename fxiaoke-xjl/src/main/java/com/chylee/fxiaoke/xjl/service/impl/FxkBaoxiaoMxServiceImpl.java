...
import com.chylee.fxiaoke.xjl.service.FxkBaoxiaoMxService;
...
@Service
public class FxkBaoxiaoMxServiceImpl extends AbstractCrmServiceImpl implements FxkBaoxiaoMxService {
    public FxkBaoxiaoMxServiceImpl(AccessTokenManager accessTokenManager) {
